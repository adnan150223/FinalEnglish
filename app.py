...
# Function to display the resized image at the top
def display_image():
    st.image("download.jpeg", caption="Meet Taksa - Your Friendly English Expert", width=200)

# Display image at the top
display_image()

# Define MCQ Prompt Template
    ...
    [
        (
            ...
            (
                ...
                "Ensure that questions are of tough level so we can assess the person’s level and that each question only has one correct answer. "
